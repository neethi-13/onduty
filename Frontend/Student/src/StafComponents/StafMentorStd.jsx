...
function StafMentorStd() {
  ...
  const handleApprove = async (od) => {
    ...
    const updatedOd = {
      ...od,
      mentorApproved: true,
      status: od.clsaApproved ? "WAITING FOR HOD" : "MENTOR APPROVED"
    };
  ...
  return (
    <div>
      ...
      <h4>Mentor Approval Requests</h4>
